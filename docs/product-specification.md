...
A real historical story, normally two per issue. Discovery first inspects at least four distinct Israeli-history source pages about unrelated subjects, then selects the two most interesting unique candidates. Whenever at least two candidates pass, both are returned rather than replaced with generated stories. Prefer stories about Israeli streets, neighborhoods, buildings, stations, markets, institutions, food, customs, public places, everyday objects, transport routes, local businesses, ordinary practices, approaching holidays, and past events still visible in ordinary local life. It may also be a broader story from Israeli history, world history, science, technology, transport, culture, food, business, a famous success or failure, an invention, or another unusual event.
...
Inspect at least four distinct source pages for unrelated Israeli historical stories and normally select the best two. Favor short, concrete stories that are interesting, easy to explain, and rich in useful ordinary language. They need not relate to the current date or current events. Gather facts and sources before writing the adaptations.
